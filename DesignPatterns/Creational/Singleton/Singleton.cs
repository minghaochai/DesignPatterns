...
// e.g. database repo, object factory
// use case
// constructor call is expensive
// take care of lazy instantiation and thread saftety (race condition)
namespace DesignPatterns.Creational.Singleton
{
    ...
    public class SingletonDatabase : IDatabase
    {
        ...
        // laziness + thread safety, only calls class constructor when it is bein used.
